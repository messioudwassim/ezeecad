...
// visitee, au lieu d'un seul gros bundle (592 Ko) charge des le premier
// affichage de la landing page. Reduit fortement le temps de premier
// chargement, surtout sur connexion mobile.
